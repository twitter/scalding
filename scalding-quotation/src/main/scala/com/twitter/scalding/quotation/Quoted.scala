...
object Quoted {
  ...
  def function[T1, T2, U](f: (T1, T2) => U): Function2[T1, T2, U] with QuotedFunction =
    macro QuotedMacro.function
  def function[T1, T2, T3, U](f: (T1, T2, T3) => U): Function3[T1, T2, T3, U] with QuotedFunction =
    macro QuotedMacro.function
  def function[T1, T2, T3, T4, U](f: (T1, T2, T3, T4) => U): Function4[T1, T2, T3, T4, U]
    with QuotedFunction = macro QuotedMacro.function
  def function[T1, T2, T3, T4, T5, U](f: (T1, T2, T3, T4, T5) => U): Function5[T1, T2, T3, T4, T5, U]
    with QuotedFunction = macro QuotedMacro.function
}
