...
object Joiner extends java.io.Serializable {
  ...
  sealed abstract class JoinFunction[K, V1, V2, R]
      extends Function3[K, Iterator[V1], Iterable[V2], Iterator[R]]
  ...
  final case class JoinFromHashJoin[K, V1, V2, R](hj: (K, V1, Iterable[V2]) => Iterator[R])
      extends JoinFunction[K, V1, V2, R] {
   ...
   */
  final def isInnerJoinLike[K, V1, V2, R](
      jf: (K, Iterator[V1], Iterable[V2]) => Iterator[R]
  ): Option[Boolean] =
    jf match {
   ...
   */
  final def isLeftJoinLike[K, V1, V2, R](
      jf: (K, Iterator[V1], Iterable[V2]) => Iterator[R]
  ): Option[Boolean] =
    jf match {
      case InnerJoin()            => Some(true)
   ...
   */
  final def isRightJoinLike[K, V1, V2, R](
      jf: (K, Iterator[V1], Iterable[V2]) => Iterator[R]
  ): Option[Boolean] =
    jf match {
      case InnerJoin()            => Some(true)
