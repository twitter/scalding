...
trait ColumnDefiner {
  ...
  protected def bigint(name: String, nullable: IsNullable = NotNullable)(
      implicit coldef: DriverColumnDefiner[BIGINT.type]) = coldef(name, nullable)
  ...
  protected def smallint(name: String, nullable: IsNullable = NotNullable)(
      implicit coldef: DriverColumnDefiner[SMALLINT.type]) = coldef(name, nullable)
  protected def tinyint(name: String, nullable: IsNullable = NotNullable)(
      implicit coldef: DriverColumnDefiner[TINYINT.type]) = coldef(name, nullable)
  protected def varchar(name: String, nullable: IsNullable = NotNullable)(
      implicit coldef: DriverColumnDefiner[VARCHAR.type]) = coldef(name, nullable)
  ...
  protected def datetime(name: String, nullable: IsNullable = NotNullable)(
      implicit coldef: DriverColumnDefiner[DATETIME.type]) = coldef(name, nullable)
  ...
  protected def double(name: String, nullable: IsNullable = NotNullable)(
      implicit coldef: DriverColumnDefiner[DOUBLE.type]) = coldef(name, nullable)
}
