...
public class ScroogeStructConverterTest {
  ...
  public void testBinary() throws Exception {
    // Commenting this out because the autogenerated StringAndBinary isn't correct, ie its
    // FieldValueMetaData has binary set to false for the binary field. This causes the
    // struct from thriftSchemaConverter to be incorrect.
