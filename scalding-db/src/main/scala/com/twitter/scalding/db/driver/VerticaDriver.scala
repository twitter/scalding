 ...
 */
case class OldVerticaDriver() extends JDBCDriver {
  protected override def columnMutator = VerticaExtensions.verticaMutator
 ...
 */
case class VerticaDriver() extends JDBCDriver {
  protected override def columnMutator = VerticaExtensions.verticaMutator
