...
abstract class DailySuffixLzoCodec[T](prefix: String, dateRange: DateRange)(implicit
    @transient suppliedInjection: Injection[T, Array[Byte]]
...
case class DailyPrefixSuffixLzoTsv(prefix: String, suffix: String, fs: Fields = Fields.ALL)(implicit
