...
object LzoTypedText {
  ...
  def hourlyLzoTsv[T](prefix: String)(implicit dr: DateRange,
...
class TimePathLzoTypedText[T](sep: TypedSep, path: String)(implicit dr: DateRange,
                                                           td: TypeDescriptor[T])
...
class MostRecentLzoTypedText[T](sep: TypedSep, path: String)(implicit dr: DateRange,
                                                             td: TypeDescriptor[T])
