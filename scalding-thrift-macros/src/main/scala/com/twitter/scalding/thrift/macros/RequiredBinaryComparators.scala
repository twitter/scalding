...
/**
 * Provides support for Scrooge classes in addition to primitives, cases classes, tuples etc. Use this if you
 * use Scrooge classes as `key` in your scalding job.
 * @author
 *   Mansur Ashraf.
 */
