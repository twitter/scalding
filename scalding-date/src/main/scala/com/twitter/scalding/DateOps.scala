...
object DateOps extends java.io.Serializable {
  ...
  private[scalding] object Format {
    ...
    case object DATE_WITH_DASH
        extends Format(DateOps.DATE_WITH_DASH, new Regex(emptyBegin + date + emptyEnd))
    ...
    case object DATEHOUR_WITH_DASH
        extends Format(DateOps.DATEHOUR_WITH_DASH,
    ...
    case object DATETIME_WITH_DASH
        extends Format(DateOps.DATETIME_WITH_DASH,
    ...
    case object DATETIME_HMS_WITH_DASH
        extends Format(DateOps.DATETIME_HMS_WITH_DASH,
