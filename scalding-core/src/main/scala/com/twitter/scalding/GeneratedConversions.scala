...
trait GeneratedTupleSetters extends LowPriorityTupleSetters {
  ...
  def converterFromSetter[A](ts: TupleSetter[A], gtc: GeneratedTupleConverters): Option[TupleConverter[A]] =
    (ts match {
      ...
      case TupleSetter2() => Some(gtc.TupleConverter2(TupleGetter.Casting(),
        TupleGetter.Casting()))
      case TupleSetter3() => Some(gtc.TupleConverter3(TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting()))
      case TupleSetter4() => Some(gtc.TupleConverter4(TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting()))
      ...
      case TupleSetter7() => Some(gtc.TupleConverter7(TupleGetter.Casting(),
        ...
        TupleGetter.Casting(),
        TupleGetter.Casting()))
      case TupleSetter8() => Some(gtc.TupleConverter8(TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
      ...
      case TupleSetter11() => Some(gtc.TupleConverter11(TupleGetter.Casting(),
        ...
        TupleGetter.Casting(),
        TupleGetter.Casting()))
      case TupleSetter12() => Some(gtc.TupleConverter12(TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
      ...
      case TupleSetter13() => Some(gtc.TupleConverter13(TupleGetter.Casting(),
        ...
        TupleGetter.Casting(),
        TupleGetter.Casting()))
      case TupleSetter14() => Some(gtc.TupleConverter14(TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
      ...
      case TupleSetter17() => Some(gtc.TupleConverter17(TupleGetter.Casting(),
        ...
        TupleGetter.Casting(),
        TupleGetter.Casting()))
      case TupleSetter18() => Some(gtc.TupleConverter18(TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
        ...
        TupleGetter.Casting(),
        TupleGetter.Casting()))
      case TupleSetter19() => Some(gtc.TupleConverter19(TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
        TupleGetter.Casting(),
