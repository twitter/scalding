...
/**
 * SequenceFile with explicit types. Useful for debugging flows using the Typed API. Not to be used for
 * permanent storage: uses Kryo serialization which may not be consistent across JVM instances. Use Thrift
 * sources instead.
 */
