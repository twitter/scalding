...
object TypedText {
   ...
   */
  private def hourly[T](sep: TypedSep, prefix: String)(
  ...
  def hourlyTsv[T](prefix: String)(implicit dr: DateRange,
                                   td: TypeDescriptor[T]): TypedTextDelimited[T] =
    hourly(TAB, prefix)

  def hourlyOsv[T](prefix: String)(implicit dr: DateRange,
                                   td: TypeDescriptor[T]): TypedTextDelimited[T] =
    hourly(ONE, prefix)

  def hourlyCsv[T](prefix: String)(implicit dr: DateRange,
                                   td: TypeDescriptor[T]): TypedTextDelimited[T] =
    hourly(COMMA, prefix)

  private def daily[T](sep: TypedSep, prefix: String)(
      implicit dr: DateRange,
      td: TypeDescriptor[T]): TypedTextDelimited[T] = {
    require(prefix.last != '/', "prefix should not include trailing /")
  ...
  def dailyTsv[T](prefix: String)(implicit dr: DateRange,
                                  td: TypeDescriptor[T]): TypedTextDelimited[T] =
    daily(TAB, prefix)

  def dailyOsv[T](prefix: String)(implicit dr: DateRange,
                                  td: TypeDescriptor[T]): TypedTextDelimited[T] =
    daily(ONE, prefix)

  def dailyCsv[T](prefix: String)(implicit dr: DateRange,
                                  td: TypeDescriptor[T]): TypedTextDelimited[T] =
    daily(COMMA, prefix)

  private def dailyPrefixSuffix[T](sep: TypedSep, prefix: String, suffix: String)(
      implicit dr: DateRange,
      td: TypeDescriptor[T]): TypedTextDelimited[T] = {
    require(prefix.last != '/', "prefix should not include trailing /")
  ...
  def dailyPrefixSuffixTsv[T](prefix: String, suffix: String)(
      implicit dr: DateRange,
      td: TypeDescriptor[T]): TypedTextDelimited[T] =
  ...
  def dailyPrefixSuffixCsv[T](prefix: String, suffix: String)(
      implicit dr: DateRange,
      td: TypeDescriptor[T]): TypedTextDelimited[T] =
...
class MostRecentTypedText[T](sep: TypedSep, path: String)(implicit dr: DateRange,
                                                          td: TypeDescriptor[T])
