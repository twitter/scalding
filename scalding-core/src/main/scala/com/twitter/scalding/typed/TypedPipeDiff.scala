...
object TypedPipeDiff {
   ...
   */
  def diff[T: KeyGrouping](left: TypedPipe[T], right: TypedPipe[T], reducers: Option[Int] = None): UnsortedGrouped[T, (Long, Long)] = {
   ...
   */
  def diffByGroup[T, K: KeyGrouping](
    left: TypedPipe[T],
    right: TypedPipe[T],
  ...
  def diffByHashCode[T](
    left: TypedPipe[T],
    right: TypedPipe[T],
    reducers: Option[Int] = None): TypedPipe[(T, (Long, Long))] = diffByGroup(left, right, reducers)(_.hashCode)(KeyGrouping(BinaryOrdering
    .ordSer[Int]))
  ...
  object Enrichments {
    ...
    implicit class Diff[T](val left: TypedPipe[T]) extends AnyVal {
      ...
      def diff(right: TypedPipe[T], reducers: Option[Int] = None)(implicit ev: KeyGrouping[T]): UnsortedGrouped[T, (Long, Long)] =
        TypedPipeDiff.diff(left, right, reducers)

      def diffByGroup[K: KeyGrouping](right: TypedPipe[T], reducers: Option[Int] = None)(groupByFn: T => K): TypedPipe[(T, (Long, Long))] =
