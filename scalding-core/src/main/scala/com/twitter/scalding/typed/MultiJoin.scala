 ...
 * However, it just calls the underlying methods on CoGroupable and flattens the resulting tuple
 */
object MultiJoin extends java.io.Serializable {
  ...
  def apply[KEY, A, B, C, D, E, F, G, H, I](
      ...
      h: CoGroupable[KEY, H],
      i: CoGroupable[KEY, I]
  ): CoGrouped[KEY, (A, B, C, D, E, F, G, H, I)] =
    a.join(b)
      .join(c)
      .join(d)
      .join(e)
  ...
  def apply[KEY, A, B, C, D, E, F, G, H, I, J](
      ...
      i: CoGroupable[KEY, I],
      j: CoGroupable[KEY, J]
  ): CoGrouped[KEY, (A, B, C, D, E, F, G, H, I, J)] =
    a.join(b)
      .join(c)
      .join(d)
      .join(e)
  ...
  def left[KEY, A, B, C](
      ...
      b: CoGroupable[KEY, B],
      c: CoGroupable[KEY, C]
  ): CoGrouped[KEY, (A, Option[B], Option[C])] =
    a.leftJoin(b)
      .leftJoin(c)
      .mapValues(tup => flattenNestedTuple(tup))
  ...
  def left[KEY, A, B, C, D, E, F, G, H](
      ...
      g: CoGroupable[KEY, G],
      h: CoGroupable[KEY, H]
  ): CoGrouped[KEY, (A, Option[B], Option[C], Option[D], Option[E], Option[F], Option[G], Option[H])] =
    a.leftJoin(b)
      .leftJoin(c)
      .leftJoin(d)
      .leftJoin(e)
  ...
  def left[KEY, A, B, C, D, E, F, G, H, I](
      a: CoGroupable[KEY, A],
      b: CoGroupable[KEY, B],
      c: CoGroupable[KEY, C],
      d: CoGroupable[KEY, D],
  ...
  def left[KEY, A, B, C, D, E, F, G, H, I, J](
      a: CoGroupable[KEY, A],
      b: CoGroupable[KEY, B],
      c: CoGroupable[KEY, C],
      d: CoGroupable[KEY, D],
  ...
  def left[KEY, A, B, C, D, E, F, G, H, I, J, K](
      a: CoGroupable[KEY, A],
      b: CoGroupable[KEY, B],
      c: CoGroupable[KEY, C],
      d: CoGroupable[KEY, D],
  ...
  def outer[KEY, A, B](
      a: CoGroupable[KEY, A],
      b: CoGroupable[KEY, B]
  ): CoGrouped[KEY, (Option[A], Option[B])] =
    a.outerJoin(b)
  ...
  def outer[KEY, A, B, C, D, E, F, G](
      ...
      f: CoGroupable[KEY, F],
      g: CoGroupable[KEY, G]
  ): CoGrouped[KEY, (Option[A], Option[B], Option[C], Option[D], Option[E], Option[F], Option[G])] =
    a.outerJoin(b)
      .outerJoin(c)
      .outerJoin(d)
      .outerJoin(e)
  ...
  def outer[KEY, A, B, C, D, E, F, G, H, I, J](
      a: CoGroupable[KEY, A],
      b: CoGroupable[KEY, B],
      c: CoGroupable[KEY, C],
      d: CoGroupable[KEY, D],
  ...
  def outer[KEY, A, B, C, D, E, F, G, H, I, J, K](
      a: CoGroupable[KEY, A],
      b: CoGroupable[KEY, B],
      c: CoGroupable[KEY, C],
      d: CoGroupable[KEY, D],
