...
class TupleAdderTest extends WordSpec with Matchers {
  "A TupleAdderJob" should {
    JobTest(new TupleAdderJob(_))
      ...
      .sink[(Int, String, String, Int, Int)](TypedText.tsv[(Int, String, String, Int, Int)]("output")) {
        outBuf =>
...
class TypedPipeSortByJob(args: Args) extends Job(args) {
  TypedPipe
    .from(TypedText.tsv[(Int, Float, String)]("input"))
    .groupBy(_._1)
    .sortBy(_._2)
    .mapValues(_._3)
    .sum
...
class TypedPipeJoinJob(args: Args) extends Job(args) {
  Tsv("inputFile0").read
    ...
    .group
    .leftJoin(TypedPipe.fromPipe[(Int, Int)](Tsv("inputFile1").read, (0, 1)).group)
    .toTypedPipe
...
class TypedPipeJoinTest extends WordSpec with Matchers {
  "A TypedPipeJoin" should {
    JobTest(new com.twitter.scalding.TypedPipeJoinJob(_))
      ...
      .typedSink[(Int, (Int, Option[Int]))](TypedText.tsv[(Int, (Int, Option[Int]))]("outputFile")) {
        outputBuffer =>
          val outMap = outputBuffer.toMap
          "correctly join" in {
...
class TJoinCountJob(args: Args) extends Job(args) {
  TypedPipe
    .fromPipe[(Int, Int)](Tsv("in0", (0, 1)), (0, 1))
    .group
    .join(TypedPipe.fromPipe[(Int, Int)](Tsv("in1", (0, 1)), (0, 1)).group)
    .size
  ...
  TypedPipe
    .fromPipe[(Int, Int)](Tsv("in0", (0, 1)), (0, 1))
    .group
    .leftJoin(TypedPipe.fromPipe[(Int, Int)](Tsv("in1", (0, 1)), (0, 1)).group)
    //Flatten out to three values:
    .toTypedPipe
...
class TNiceJoinCountJob(args: Args) extends Job(args) {
  ...
  TypedPipe
    .fromPipe[(Int, Int)](Tsv("in0", (0, 1)), (0, 1))
    .join(TypedPipe.fromPipe[(Int, Int)](Tsv("in1", (0, 1)), (0, 1)))
    .size
    .write(TypedText.tsv[(Int, Long)]("out"))
  ...
  TypedPipe
    .fromPipe[(Int, Int)](Tsv("in0", (0, 1)), (0, 1))
    .leftJoin(TypedPipe.fromPipe[(Int, Int)](Tsv("in1", (0, 1)), (0, 1)))
    //Flatten out to three values:
    .toTypedPipe
    .map { kvw: (Int, (Int, Option[Int])) =>
      (kvw._1, kvw._2._1, kvw._2._2.getOrElse(-1))
...
class TNiceJoinByCountJob(args: Args) extends Job(args) {
  ...
  (TypedPipe
    .fromPipe[(Int, Int)](Tsv("in0", (0, 1)), (0, 1))
    .joinBy(TypedPipe.fromPipe[(Int, Int)](Tsv("in1", (0, 1)), (0, 1))))(_._1, _._1)
    .size
    .write(TypedText.tsv[(Int, Long)]("out"))
  ...
  (TypedPipe
    .fromPipe[(Int, Int)](Tsv("in0", (0, 1)), (0, 1))
    .leftJoinBy(TypedPipe.fromPipe[(Int, Int)](Tsv("in1", (0, 1)), (0, 1))))(_._1, _._1)
    //Flatten out to three values:
    .toTypedPipe
      ...
      JobTest(new TCrossJob(_))
        ...
        .typedSink(TypedText.tsv[(String, String)]("crossed")) { outbuf =>
          ...
          (idx + ": create a cross-product") in {
            sortedL shouldBe List(("all", "body"), ("all", "every"), ("you", "body"), ("you", "every"))
          }
          idx += 1
        }
        .run
      ...
      .typedSink(TypedText.tsv[(Int, Int, Int, Int)]("output")) { outBuf =>
        "correctly do a multi-self-join" in {
          def group(it: Seq[(Int, Int)])(red: (Int, Int) => Int): Map[Int, Int] =
            it.groupBy(_._1).map { case (k, kvs) =>
...
class TypedPipeRequireTest extends FunSuite {
  test("requireSingleValuePerKey should not cause a job to fail") {
    ...
    assert(
      ex(false).waitFor(Config.empty, Local(true)).get.toList.sorted ==
...
object TypedPipeConverterTest {
  class TypedTsvWithCustomConverter[T: TypeDescriptor](nonSerializableObj: Any, path: String*)
      extends FixedTypedText[T](TypedText.TAB, path: _*) {
...
object TypedPipeCrossWithMapWithToPipeTest {
  ...
  class TestJob(args: Args) extends Job(args) {
    val mapPipe: TypedPipe[Map[Int, Int]] = TypedPipe
      .from(source)
      .groupAll
      .toList
