...
class HRavenOrdinaryMedianRuntimeBasedEstimator extends RuntimeMedianReducerEstimator with OrdinaryRuntimeReducerEstimator with HRavenHistoryService
class HRavenOrdinaryMeanRuntimeBasedEstimator extends RuntimeMeanReducerEstimator with OrdinaryRuntimeReducerEstimator with HRavenHistoryService
class HRavenInputScaledMedianRuntimeBasedEstimator extends RuntimeMedianReducerEstimator with InputScaledRuntimeReducerEstimator with HRavenHistoryService
class HRavenInputScaledMeanRuntimeBasedEstimator extends RuntimeMeanReducerEstimator with InputScaledRuntimeReducerEstimator with HRavenHistoryService
