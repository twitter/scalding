 ...
 */
object ScroogeOrderedSerializationImpl {

  def apply[T <: ThriftStruct](c: Context)(implicit T: c.WeakTypeTag[T]): c.Expr[ScroogeOrderedSerialization[T]] = {
    import c.universe._
    val tpe = T.tpe
    ...
    val res = q"""
      ...
      new _root_.com.twitter.scalding.commons.thrift.ScroogeOrderedSerialization[$T] with _root_.com.twitter.bijection.macros.MacroGenerated {
        override val minFieldId: Short = generatedMin
        override lazy val thriftStructSerializer  = $companionSymbol
      }
      """
    c.Expr[com.twitter.scalding.commons.thrift.ScroogeOrderedSerialization[T]](res)
  }
