 ...
 */
sealed abstract class SkewReplicationStrategy {
 ...
 */
case class SkewReplicationStrategyA(replicationFactor : Int = 1) extends SkewReplicationStrategy {
 ...
 */
case class SkewReplicationStrategyB(maxKeysInMemory : Int = 1E6.toInt, maxReducerOutput : Int = 1E7.toInt)
  extends SkewReplicationStrategy {
