// following were autogenerated by scripts/operations_generator.rb at Mon Oct 29 16:39:47 -0700 2012 do not edit
...
trait GeneratedRichPipeOperations extends FieldConversions {
  ...
  def filter[T](fs : Fields)(fn : (T) => Boolean)
    (implicit conv : TupleConverter[T]) : Pipe
...
trait GeneratedReduceOperations[Self <: GeneratedReduceOperations[Self]] extends FieldConversions {
  ...
  def count[T:TupleConverter](fs : (Fields,Fields))(fn : (T) => Boolean)
    : Self
  ...
  def forall[T:TupleConverter](fs : (Fields,Fields))(fn : (T) => Boolean)
    : Self
  ...
  def toList[T:TupleConverter](fs : (Fields,Fields))
    : Self
  ...
  def sortWithTake[T:TupleConverter](fs : (Fields,Fields), k : Int)(fn : (T,T) => Boolean)
    : Self
...
trait GeneratedFoldOperations[Self <: GeneratedFoldOperations[Self]] extends GeneratedReduceOperations[Self] {
  ...
  def foldLeft[R,T](fs : (Fields,Fields))(init : R)(fn : (R,T) => R)
    (implicit setter : TupleSetter[R], conv : TupleConverter[T]) : Self
...
trait GeneratedStreamOperations[Self <: GeneratedStreamOperations[Self]] extends FieldConversions {
  ...
  def dropWhile[T](fs : Fields)(fn : (T) => Boolean)
  ...
  def scanLeft[R,T](fs : (Fields,Fields))(init : R)(fn : (R,T) => R)
    (implicit setter : TupleSetter[R], conv : TupleConverter[T]) : Self
  ...
  def takeWhile[T](fs : Fields)(fn : (T) => Boolean)
    (implicit conv : TupleConverter[T]) : Self
